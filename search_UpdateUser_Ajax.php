...
echo '<thead class="table-dark"><tr><th>ID User</th><th>Username</th><th>Password</th><th>Status</th><th>Aksi</th></tr></thead><tbody>';
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        echo '<tr>
                ...
                <td>
                    <a class="btn btn-warning btn-sm" href="editUser.php?kode=' . $row['iduser'] . '">Edit</a>
                    <a class="btn btn-danger btn-sm delete-btn" data-id="' . $row['iduser'] . '">Hapus</a>
                </td>
              </tr>';
    }
} else {
